						...
						<div class="col-xl-8 col-lg-7">
							<div class="card shadow mb-4">
								...
								<div class="card-body" style=" width:100%">
									<div class="video-area" style="height:20rem">
										<video src="${pageContext.request.contextPath }/resources/video/c42d322c466e87102b3e2c120485c517.mp4" 
										controls loop autoplay="autoplay" poster=""
										style="width:100%; margin:0 auto;">브라우저가 지원하지 않습니다.</video>
									</div>
								</div>
							</div>
						</div>
